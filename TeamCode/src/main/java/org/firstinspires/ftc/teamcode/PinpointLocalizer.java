...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1161.5752343692686; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3172.325523175756; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        double milPerTick = 25.4 * inPerTick;
        // TODO: make sure your config has a Pinpoint device with this name
        //   see https://ftc-docs.firstinspires.org/en/latest/hardware_and_software_configuration/configuring/index.html
        driver = hardwareMap.get(GoBildaPinpointDriver.class, "pinpoint");

        driver.setEncoderResolution(1 / milPerTick, DistanceUnit.MM);
