...
public final class TurretShooter {
    ...
    public static TurretParams TPARAMS = new TurretParams();
    ...
    public final  CRServo turretAngle; // stays CRServo, now controlled by D-pad
    ...
    public void setShooterPower(double leftMotorPower, double rightMotorPower){
        if (leftMotorPower>0 && leftMotorPower<=1){
            leftMotor.setPower(leftMotorPower);
        }
        if (rightMotorPower>0 && rightMotorPower<=1){
            rightMotor.setPower(rightMotorPower);
        }

    }

    public double leftMotorSpeed (ElapsedTime timer){

    }

    public double rightMotorSpeed (ElapsedTime timer){

    }

    public void setBothMotorSpeed(int speed){
